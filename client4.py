...
class Goui:
    def __init__(self,root,queue,socket,display):
        ...
        self.labelp0 = Label(midFrame, text="\nGame will start when every player\nhas pressed on buttons below", font=fontStyleP0, width =25, height=4, anchor='n') #P0 below Pot
...
#############  GUI ends HERE #####################
    ...
    def printTable(self):
        ...
        if platform.system() == "Windows": #Unicode works won windows 10
            ...
            self.display.commonCards = replaceMac1(self.display.commonCards)
